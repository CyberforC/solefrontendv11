            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b borde-gray-200">
                                    ...
                                    {   authors?.map((author) => (
                                            <tr className="bg-white border-b" key={author.id}>
                                                ...
                                                <td className="flex space-x-2 text-sm text-gray-900 font-light px-6 py-4">
                                                    <ViewLink href={{ pathname: `/authors/show/[id]`, query: { id:author.id } }} as={`/authors/show/${author.id}`}>
                                                    </ViewLink>
                                                    <EditLink href={{ pathname: `/authors/edit/[id]`, query: { id:author.id } }} as={`/authors/edit/${author.id}`}>
                                                    </EditLink>
                                                    <ProfileLink href={{ pathname: `/authors/[id]/profile/create`, query: { id:author.id } }} as={`/authors/${author.id}/profile/create`}>
                                                    </ProfileLink>
                                                    <NoteLink href={{pathname: `/authors/[id]/notes`, query: { id: author.id }}} as={`/authors/${author.id}/notes`}>
                                                    </NoteLink>
                                                    <RatingLink href={{pathname: `/authors/[id]/ratings/create`, query: { id: author.id }}} as={`/authors/${author.id}/ratings/create`}>
                                                    </RatingLink>
