...
const Create = () => {
    ...
    useEffect(() => {
        ...
        if (router.isReady)
        {
            ...
            {
                console.log(router.query.idNote)
                axios
                    .get(`/api/authors/notes/${router.query.idNote}`)
                    .then(resTwo => {
                        console.log(resTwo.data)
                        console.log(resTwo.data.description)
                        console.log(resTwo.data.writing_date)
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <form onSubmit={submitForm}>
                                <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
                                    ...
                                    <Button>Guardar nota de autor</Button>
                                </div>
                            </form>
                            <div className="flex justify-end">
                                <PreviousLink href={{ pathname: `/authors/[id]/notes`, query: { id: router.query.id } }} as={`/authos/${router.query.id}/notes`}>
                                </PreviousLink>
                            </div>
                        </div>
                    </div>
